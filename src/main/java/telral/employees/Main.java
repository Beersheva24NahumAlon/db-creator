...
import static telral.employees.Properties.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        DepartmentStaff[] departments = {
                new DepartmentStaff("QA", QA_N_MANAGERS, QA_N_EMPLOYEES, QA_N_WAGE_EMPLOYEES, QA_N_SALES_PERSONS),
                new DepartmentStaff("Development", DEV_N_MANAGERS, DEV_N_EMPLOYEES, DEV_N_WAGE_EMPLOYEES, DEV_N_SALES_PERSONS),
                new DepartmentStaff("Devops", DEVOPS_N_MANAGERS, DEVOPS_N_EMPLOYEES, DEVOPS_N_WAGE_EMPLOYEES, DEVOPS_N_SALES_PERSONS),
                new DepartmentStaff("Sales", SALES_N_MANAGERS, SALES_N_EMPLOYEES, SALES_N_WAGE_EMPLOYEES, SALES_N_SALES_PERSONS)
        };
